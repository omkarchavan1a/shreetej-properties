                ...
                <div>
                  ...
                  <form ref={formRef} action={handleAction} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="relative group/input">
                        ...
                        <input
                          ...
                          className="w-full px-5 py-4 bg-[#f8f6f2] border-[1.5px] border-gold/20 rounded-xl text-[14px] text-text-dark outline-none focus:bg-white focus:border-gold focus:ring-4 focus:ring-gold/10 focus:shadow-[0_0_20px_rgba(201,148,58,0.1)] transition-all duration-300 placeholder:text-navy/30"
                        />
                      </div>
                      <div className="relative group/input">
                    ...
                    <div className="relative group/input">
                      ...
                      <select id="service" name="service" className="w-full px-5 py-4 bg-[#f8f6f2] border-[1.5px] border-gold/20 rounded-xl text-[14px] text-text-dark outline-none focus:bg-white focus:border-gold focus:ring-4 focus:ring-gold/10 focus:shadow-[0_0_20px_rgba(201,148,58,0.1)] transition-all duration-300 appearance-none cursor-pointer">
                    ...
                    <div className="relative group/input">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-5 py-4 bg-[#f8f6f2] border-[1.5px] border-gold/20 rounded-xl text-[14px] text-text-dark outline-none focus:bg-white focus:border-gold focus:ring-4 focus:ring-gold/10 focus:shadow-[0_0_20px_rgba(201,148,58,0.1)] transition-all duration-300 resize-y placeholder:text-navy/30"
                      ></textarea>
                    </div>
