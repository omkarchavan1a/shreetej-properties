...
export default async function CommercialDetailsPage({ params }: { params: Promise<{ id: string }> }) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            {galleryImages.length > 0 && (
              <div>
                <h2 className="font-serif text-3xl text-navy font-bold mb-6">Project Gallery</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {galleryImages.map((imgUrl, idx) => (
                    <div 
                      key={idx} 
                      className="group relative rounded-3xl overflow-hidden shadow-md aspect-[4/3] border border-gold/10 cursor-pointer"
                    >
                      <div 
