...
async function seedData() {
  ...
  try {
    ...
    await db.insert(blogs).values([
      {
        ...
        content: "<p>Sustainable real estate is no longer just a trend; it's a necessity. In Maharashtra, we are seeing a significant shift towards eco-friendly building practices, renewable energy integration, and water conservation methods in new developments.</p><p>Shreetej Properties Builders & Developers is at the forefront of this movement, ensuring that our projects not only provide luxurious living spaces but also minimize environmental impact.</p>",
        excerpt: "Exploring the shift towards eco-friendly building practices and how Shreetej Properties Builders & Developers leads in sustainable development in Maharashtra.",
      ...
      },
      {
        ...
        content: "<p>Buying your first property can be a daunting experience. From understanding home loans to navigating legal documentation, there are many steps involved.</p><p>At Shreetej Properties Builders & Developers, we simplify this process for our clients. Here is our comprehensive guide to help you take that important first step onto the property ladder.</p><ul><li>Understand your budget and financing options</li><li>Location, Location, Location</li><li>Verify all legal documents</li></ul>",
    ...
    await db.insert(press).values([
      {
        title: "Shreetej Properties Builders & Developers Earns Award for Excellence in Customer Service",
      ...
      },
      {
        ...
        excerpt: "Shreetej Properties Builders & Developers announces the launch of their latest eco-friendly residential complex, setting new standards for green living.",
      ...
      },
      {
        ...
        excerpt: "The social arm of Shreetej Properties Builders & Developers expands its initiative to empower women and support education in rural areas.",
